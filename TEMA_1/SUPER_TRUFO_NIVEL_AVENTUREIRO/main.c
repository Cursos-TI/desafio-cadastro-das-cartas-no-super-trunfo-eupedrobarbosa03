...
int main(){
    ...
    char codigo_estado_carta1[4], codigo_estado_carta2[4];
    ...
    printf("Letra do Estado: %c\nCódigo do Estado: %s\nCidade: %s\nPopulação: %d\nÁrea: %.2fkm²\nPIB: %.2f\nQuantidade de Pontos Turísticos: %d\nDensidade Populacional: %.2f hab/km²\nPIB por Capita: %.2f reais.\n", letra_estado_carta1, codigo_estado_carta1, nome_cidade_carta1, populacao_carta1, area_carta1, pib_carta1, qtd_pontos_turisticos_carta1, densidade_populacional_carta1, pib_por_capita_carta1);
    ...
    printf("Letra do Estado: %c\nCódigo do Estado: %s\nCidade: %s\nPopulação: %d\nÁrea: %.2fkm²\nPIB: %.2f\nQuantidade de Pontos Turísticos: %d\nDensidade Populacional: %.2f hab/km²\nPIB por Capita: %.2f reais.\n", letra_estado_carta2, codigo_estado_carta2, nome_cidade_carta2, populacao_carta2, area_carta2, pib_carta2, qtd_pontos_turisticos_carta2, densidade_populacional_carta2, pib_por_capita_carta2);
